defmodule AinComBooking.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AinComBooking.Repo)
  ...
  """
  def valid_password?(%AinComBooking.Accounts.User{hashed_password: hashed_password}, password) when is_binary(hashed_password) and byte_size(password) > 0 do
