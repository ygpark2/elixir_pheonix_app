defmodule AinComBookingWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AinComBooking.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AinComBooking.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AinComBooking.Gettext, "errors", msg, opts)
    end
  end
