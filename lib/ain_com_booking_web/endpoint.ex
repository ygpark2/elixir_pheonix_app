defmodule AinComBookingWeb.Endpoint do
  ...
  socket("/socket", AinComBookingWeb.Socket)
  socket("/live", Phoenix.LiveView.Socket, websocket: [connect_info: [session: {AinComBookingWeb.Session, :config, []}]])

  plug(AinComBookingWeb.Plugs.Security)
  plug(:ping)
  plug(:canonical_host)
  plug(:force_ssl)
  plug(:cors)
  ...
  plug(AinComBookingHealth.Router)
