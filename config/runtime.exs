...
if get_env("PHX_SERVER", :boolean) == true do
  config :ain_com_booking, AinComBooking.Endpoint, server: true
end
...
config :ain_com_booking, AinComBooking.TelemetryUI, share_key: get_env("TELEMETRY_UI_SHARE_KEY")
...
config :ain_com_booking, Corsica, origins: get_env("CORS_ALLOWED_ORIGINS", :cors)
